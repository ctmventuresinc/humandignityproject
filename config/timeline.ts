...
export const TIMELINE_TIMINGS = {
  ...
  COUNTDOWN_DURATION: 500, // 0.5 seconds per countdown number
  
  // Scanning step
  SCANNING_DURATION: 1000, // 1 second for scan line animation
  ...
  // Scan line animation
  SCAN_LINE_DURATION: 1000, // Should match SCANNING_DURATION for smooth animation
} as const;
